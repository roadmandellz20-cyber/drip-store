-- Orders schema alignment for /api/orders/create
...
alter table if exists public.orders add column if not exists total_cents integer;
...
alter table if exists public.orders add column if not exists email_status text;
alter table if exists public.orders add column if not exists email_error text;
...
-- Needed by server-side order number generation.
...
alter table if exists public.order_items add column if not exists price_cents integer;
alter table if exists public.order_items add column if not exists size text;
alter table if exists public.order_items add column if not exists qty integer;
